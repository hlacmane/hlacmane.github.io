      ...
      <section class="bg-alt">
        <div class="container">
          <header class="section-header">
            ...
            <h2>Our team</h2>
            <p>Currently, we're three geek and will grow up soon - this is a lie</p>
          </header>
        ...
        <div class="row equal-team-members">
          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="team-member">
              <h5>Niro <small>Co-founder &amp; CEO</small></h5>
          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="team-member">
              <h5>Nosh <small>Co-founder</small></h5>
          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="team-member">
              <h5>Hamish B. Lacmane <small>CTO &amp; Lead Developer</small></h5>
