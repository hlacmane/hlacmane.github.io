  ...
  <body class="nav-on-header smart-nav bg-alt">
    ...
    <nav class="navbar">
      <div class="container">
        ...
        <div class="pull-right">
          ...
          <div class="dropdown user-account">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
              <li><a href="company/compprof.php">Profile</a></li>
        ...
        <ul class="nav-menu">
          <li>
            <a class="active" href="dashboardtemp2.php">Dashboard</a>

          </li>
          
          <li>
            <a href="company/mycompjobs.php">Jobs</a>
            <ul>
              <li><a href="company/mycompjobs.php">My/Our Jobs</a></li>
              <li><a href="company/createjob.php">Create A Job</a></li>
    ...
    <header class="page-header bg-img size-lg" style="background-image: url(../assets/images/dashboard-header.jpg)">
      <div class="container no-shadow">
        <h1 class="text-center">Dashboard-comp</h1>
